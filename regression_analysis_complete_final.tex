...
This difficulty has a name, and it gets rapidly worse as predictors accumulate. As the number of predictors grows, the volume of the space they span grows exponentially, so any fixed sample becomes sparse within it. Statisticians call this the \emph{curse of dimensionality}, a phrase due to Richard Bellman.\index{curse of dimensionality}
