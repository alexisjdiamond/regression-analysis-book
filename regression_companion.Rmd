...
A first difference is a separate matter. In the simple model the intercept
cancels, so rescaling the slope's interval is legitimate -- but that survives
only because the difference loads on a single coefficient. Add a quadratic term
and it fails again.
